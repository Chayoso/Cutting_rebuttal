...
# 4 fruits x 7 friction values = 28 cuts.
set -u
cd "$(dirname "$0")"
...
# Order: watermelon_slice first (most slip-prone, biggest expected drift),
# then large/round, asymmetric, small. Keeps the visually interesting case
# available early.
for FRUIT in watermelon_slice apple banana grape; do
